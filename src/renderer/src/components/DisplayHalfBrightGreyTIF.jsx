...
// Displays greyscale image at 50% brightness
function DisplayHalfBrightGreyTIF({ imageUrl }) {
        ...
        if (ifds.length > 0) {
          ...
          if (firstIFD.data.length === expectedDataLength) {
            ...
            for (let i = 0; i < rgbaData.length; i += 4) {
              ...
              greyValue = greyValue * 0.5 // Apply 50% brightness
...
DisplayHalfBrightGreyTIF.propTypes = {
  imageUrl: PropTypes.string.isRequired
}

export default DisplayHalfBrightGreyTIF
